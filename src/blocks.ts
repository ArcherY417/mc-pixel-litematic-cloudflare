...
function b(
  ...
  categories: string[],
  versions: string[] = ["1.20.1", "1.21"],
  map_art = true,
  survival = true
): BlockInfo {
  return { id: `minecraft:${id}`, name, rgb, categories, versions, map_art, survival };
}
...
export const BLOCKS: BlockInfo[] = [
  ...
  b("water", "Water", [64, 64, 255], ["map"], ["1.20.1", "1.21"], true, true),
  ...
  b("mangrove_planks", "Mangrove Planks", [117, 54, 48], ["wood"]),
  b("cherry_planks", "Cherry Planks", [226, 179, 172], ["wood"]),
  b("bamboo_planks", "Bamboo Planks", [194, 173, 78], ["wood"]),
  ...
  b("tuff", "Tuff", [108, 109, 102], ["natural"], ["1.21"]),
  b("tuff_bricks", "Tuff Bricks", [96, 98, 91], ["natural"], ["1.21"]),
  b("resin_block", "Resin Block", [226, 91, 34], ["natural"], ["1.21"], false, false)
];

export const BLOCK_BY_ID = new Map(BLOCKS.map((block) => [block.id, block]));
